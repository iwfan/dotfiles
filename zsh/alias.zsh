...
alias rs="GD_POSTGRES_HOST=127.0.0.1 GD_FE=local GD_FE_VITE=true GRAPHQL_CONSUMER_ORIGINS='localhost:3001, localhost:1215, localhost:4200' bundle exec rails s"
