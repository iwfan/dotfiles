    ...
    config = function()
        ...
        local section_actions = {
            ...
            val = {
                ...
                button("f", "󰱼  Find file", ":Telescope enhanced_find_files<cr>"),
                button("g", "󰷊  Git status", ":Telescope git_status<cr>"),
                button("w", "󰱽  Find word", ":Telescope live_grep<CR>"),
                button("s", "󱝴  Session", ":echo 1<CR>"),
                button("t", "󰈖  Show todo", ":TodoTelescope<CR>"),
                button("s", "󱈖  Sync plugins", ":Lazy sync<CR>"),
