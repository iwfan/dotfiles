...
local function keymaps()
    ...
    map_cmd("n|<C-f>gs", "Telescope git_status")
    map_cmd("n|<C-f>gS", "Telescope git_stash")
    map_cmd("n|<C-f>gb", "Telescope git_branches")
    map_cmd("n|<C-f>gc", "Telescope git_commits")
    map_cmd("n|<C-f>gC", "Telescope git_bcommits")
end
