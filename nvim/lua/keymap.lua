...
map_cmd("n|<leader>ff", "lua require('telescope.builtin').git_files()")
map_cmd("n|<leader>fa", "lua require('telescope.builtin').find_files()")
map_cmd("n|<leader>fb", "lua require('telescope.builtin').buffers()")
map_cmd("n|<leader>fg", "lua require('telescope.builtin').live_grep()")
map_cmd("n|<leader>fw", [[lua require('telescope.builtin').grep_string({ search = vim.fn.expand("<cword>")})]])
map_cmd("n|<leader>ft", "lua require('telescope.builtin').help_tags()")
map_cmd("n|<leader>fr", "lua require('telescope.builtin').registers()")
map_cmd("n|<leader>fh", "lua require('telescope.builtin').oldfiles()")
