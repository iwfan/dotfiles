...
map_cmd("n|<C-w><C-l>", "vnew +terminal | setlocal nobuflisted")
map_cmd("n|<C-w><C-x>", "10new +terminal | setlocal nobuflisted")
map_cmd("n|<C-w><C-t>", "terminal")
map_cmd("n|<C-w><C-g>", "tabe | term lazygit")
