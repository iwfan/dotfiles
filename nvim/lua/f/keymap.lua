...
vim.keymap.set("n", "\\q", ":<c-u>copen<cr>")
vim.keymap.set("n", "<bs>q", ":<c-u>cclose<cr>")
vim.keymap.set("n", "[q", ":<c-u>cprevious<cr>")
vim.keymap.set("n", "]q", ":<c-u>cnext<cr>")

vim.keymap.set("n", "<C-q>o", [[:lua searching_google(vim.fn.expand("<cword>"))<CR>]], { silent = true })
vim.keymap.set("n", "<C-q>t", [[:lua searching_deepl(vim.fn.expand("<cword>"))<CR>]], { silent = true })
vim.keymap.set("v", "<C-q>o", [[<ESC>gv"gy<ESC>:lua searching_google(vim.fn.getreg('g'))<CR>]], { silent = true })
