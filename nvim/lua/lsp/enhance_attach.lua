...
return function(client, bufnr)
    ...
    buf_set_keymap("n", "<space><enter>", "<cmd>Telescope lsp_code_actions theme=cursor<CR>", opts)
    buf_set_keymap("v", "<space><enter>", "<cmd>Telescope lsp_range_code_actions theme=cursor<CR>", opts)
