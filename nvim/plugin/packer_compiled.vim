...
loadstring("\27LJ\2\n°\1\0\0\4\0\6\0\t6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0005\3\4\0=\3\5\2B\0\2\1K\0\1\0\22exclude_filetypes\1\6\0\0\fLuaTree\14dashboard\nvista\thelp\14sagahover\1\0\2\23indent_start_level\3\2\22indent_guide_size\3\1\nsetup\18indent_guides\frequire\0")()
...
augroup packer_load_aucmds
  au!
  " Filetype lazy-loads
  au FileType html ++once call s:load(['coc.nvim', 'formatter.nvim'], { "ft": "html" })
  au FileType json ++once call s:load(['coc.nvim', 'formatter.nvim'], { "ft": "json" })
  au FileType css ++once call s:load(['coc.nvim', 'formatter.nvim'], { "ft": "css" })
  au FileType lua ++once call s:load(['formatter.nvim'], { "ft": "lua" })
  au FileType typescript ++once call s:load(['coc.nvim', 'formatter.nvim'], { "ft": "typescript" })
  au FileType typescriptreact ++once call s:load(['coc.nvim', 'formatter.nvim'], { "ft": "typescriptreact" })
  au FileType javascript ++once call s:load(['coc.nvim', 'formatter.nvim'], { "ft": "javascript" })
  au FileType javascriptreact ++once call s:load(['coc.nvim', 'formatter.nvim'], { "ft": "javascriptreact" })
  " Event lazy-loads
augroup END
